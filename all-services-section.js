...
(function () {
  ...
  var css = ''
    ...
    + '#all-services-section .as-card{--as-tone:#081B33;position:relative;display:grid;grid-template-columns:48px minmax(0,1fr) 42px;min-height:142px;'
    ...
    + '#all-services-section .as-card.as-tone-ink{--as-tone:#050F1F}'
    ...
    + '#all-services-section .as-card:hover .as-go{background:#981B1F}'
    ...
    + '#all-services-section .as-card.as-current{background:#081B33;color:#fff;pointer-events:none}'
